...
// Source: github.com/Remneva/otus_hw/hw12_13_14_15_calendar/internal/storage/sql (interfaces: EventsStorage)
...
func (m *MockEventsStorage) AddEvent(arg0 context.Context, arg1 sql.Event) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockEventsStorage) GetEvent(arg0 context.Context, arg1 int64) (sql.Event, error) {
	m.ctrl.T.Helper()
...
func (m *MockEventsStorage) GetEvents(arg0 context.Context) ([]sql.Event, error) {
	m.ctrl.T.Helper()
...
func (m *MockEventsStorage) UpdateEvent(arg0 context.Context, arg1 sql.Event) error {
	m.ctrl.T.Helper()
