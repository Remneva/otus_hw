...
func TestPipeline(t *testing.T) {
	...
	stages2 := []Stage{
		g("Foo", func(v interface{}) interface{} { return "FOO" }),
		g("Bar", func(v interface{}) interface{} { return v.(string) + "BAR" }),
	}
	...
	t.Run("Concatenation string", func(t *testing.T) {
		in := make(Bi)
		data := []int{1}
		...
		require.Equal(t, []string{"FOOBAR"}, result)
		require.Less(t, int64(elapsed),
